...
<div class="card">
  <div class="card-body">
    ...
    <form method="POST" action="/memories" enctype="multipart/form-data">
      @csrf
      ...
      <div class="mb-3">
        ...
        <div class="input-group">
          <textarea id="contentField" name="content" class="form-control" rows="5">{{ old('content') }}</textarea>
      ...
      <div class="mb-3">
        ...
        <select name="mood" class="form-select">
          ...
          @foreach(['happy','sad','angry','excited','calm','tired'] as $m)
            <option value="{{ $m }}" {{ old('mood') == $m ? 'selected' : '' }}>
              {{ ucfirst($m) }}
            </option>
          @endforeach
        </select>
      ...
      <div class="mb-3">
        ...
        <select name="template" class="form-select">
          ...
          <option value="travel">✈️ Travel Diary</option>
